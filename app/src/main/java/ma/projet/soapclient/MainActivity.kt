                    ...
                    try {
                        ...
                        withContext(Dispatchers.Main) {
                            if (success) {
                                ...
                                Toast.makeText(this@MainActivity, "Erreur lors de l'ajout (service returned false).", Toast.LENGTH_SHORT).show()
                            }
                        }
                    } catch (e: Exception) {
                        e.printStackTrace() // <-- Va afficher l'erreur réelle dans Logcat
                        withContext(Dispatchers.Main) {
